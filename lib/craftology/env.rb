module Craftology
  module Env
    ...
    #
    # Borrowed from the Pay gem (MIT) https://github.com/pay-rails/pay:
    def find_value_by_name(scope, name)
      ...
      Rails.logger.error <<~MESSAGE
        Rails was unable to decrypt credentials. Craftology checks the Rails credentials to look for private config.
